...
import { removeFdp, removeMtp, removePatents, removePhd, removeProjectgrands, removeStc } from '../../redux/recordsRedux';
...
const EditProject = () => {
  ...
  return (
    <Container>
      <section>{location.state?'Edit Project':'Add Project'}</section>
      <Form>
        <Entry>
